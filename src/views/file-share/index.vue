...
<script>
import { Select, Option, Button, Table, TableColumn, Tag, Upload, Main, Col, Row, Dropdown, DropdownItem, DropdownMenu, Link, Pagination, Input, Breadcrumb, BreadcrumbItem, Message } from'element-ui'
...
export default {
    ...
    methods: {
        ...
        // searchFile(){
        //     this.$axios.post(prefix.api + '/searchFile', { file_name: this.input }).then(response => {
        //         if(!responseHandler(response.data, this)){
        //             Message.error(response.data.msg)
        //         }
        //         this.document = response.data.data.data
